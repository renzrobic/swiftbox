...
export default function LoginGateway({ passInput, setPassInput, onAuthorize, isLoading }) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink p-4 pt-24 md:p-6 md:pt-32">
      <div className="w-full max-w-md rounded-xl border border-white/10 bg-white p-8 shadow-xl md:p-12">
        
        <div className="mb-10 flex flex-col items-center text-center">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-ink/5 text-ink ring-1 ring-ink/10">
        ...
        <div className="space-y-6">
          ...
          <button 
            ...
            onClick={onAuthorize}
            disabled={isLoading}
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-ink py-6 text-[10px] font-bold uppercase tracking-[0.3em] text-white shadow-md transition-all hover:-translate-y-0.5 hover:bg-black active:scale-[0.98] disabled:translate-y-0 disabled:opacity-50"
          >
            {isLoading ? (
