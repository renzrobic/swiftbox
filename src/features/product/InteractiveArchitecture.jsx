  ...
  return (
    <div className="relative flex flex-col items-center gap-3 z-10">
      <motion.div className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-all duration-1000 md:h-16 md:w-16 border border-ink/5 ${
        isActive ? 'bg-ink text-white scale-105 shadow-xl border-transparent' : 'bg-white text-ink/40 shadow-sm'
      }`}>
        <step.icon size={20} className="md:w-6 md:h-6" />
      </motion.div>
      <span className={`text-[10px] font-semibold tracking-wider transition-colors duration-1000 ${
