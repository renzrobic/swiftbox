          ...
          <div className="lg:col-span-8 space-y-32 md:space-y-48">
            ...
            <ScrollReveal>
              <div className="max-w-2xl">
                ...
                <p className="text-xl leading-relaxed text-ink/50 font-medium">
                  By uncoupling the recipient from the physical delivery timeline, we optimize <span className="text-ink">Last-Mile Logistics</span> and solve the common Attendance Problem. Riders save an average of 12 minutes per transaction by utilizing our asynchronous handshake architecture.
                </p>
              </div>
            </ScrollReveal>
