...
const FAQ_DATA = [
  {
    ...
    answer: "SwiftBox is an IoT-enabled smart locker system designed to optimize last-mile delivery. It solves the 'Attendance Problem'—where recipients are unavailable during delivery windows—by allowing couriers to securely drop parcels using an asynchronous 'Drop and Go' protocol."
  },
  {
