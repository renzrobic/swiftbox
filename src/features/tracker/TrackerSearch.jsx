      ...
      <div className={`flex items-center gap-3 rounded-full border border-ink/10 bg-white p-2 pl-8 transition-all duration-500 focus-within:scale-[1.02] focus-within:border-ink/20 focus-within:active-glow hover:active-glow ${searchId ? 'active-glow' : ''}`}>
        ...
        <div className="flex items-center gap-2 pr-2">
          ...
          <button 
            ...
            className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-ink text-white transition-all duration-300 hover:bg-black hover:text-white hover:-translate-y-0.5 active:scale-95 disabled:opacity-30 btn-ai-glow"
          >
            {loading ? (
