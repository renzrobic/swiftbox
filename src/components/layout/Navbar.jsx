    ...
    `}>
      <div className="relative z-[130] mx-auto flex w-full items-center justify-between px-6 py-5 md:px-10">
        ...
        <div className={`
          ...
          ${!isSolid ? 'text-white' : 'text-royal-blue'}
        `}>
        ...
        >
          ...
          >
            <motion.span
              ...
              className={`absolute h-[2px] w-[22px] rounded-full transition-colors ${!isSolid ? 'bg-white' : 'bg-royal-blue'}`}
            />
            <motion.span
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-6 w-full">
              <button onClick={() => handleNavClick('/')} className="text-lg font-bold tracking-tight text-royal-blue uppercase w-full text-left">Home</button>
              <button onClick={() => handleNavClick('/product')} className="text-lg font-bold tracking-tight text-royal-blue uppercase w-full text-left">Product</button>
              <button onClick={() => handleNavClick('/news')} className="text-lg font-bold tracking-tight text-royal-blue uppercase w-full text-left">News</button>
              <button onClick={() => handleNavClick('/track')} className="text-lg font-bold tracking-tight text-royal-blue uppercase w-full text-left">Tracker</button>
            </nav>
            <p className="absolute bottom-32 text-[10px] font-black uppercase tracking-[0.4em] text-royal-blue/20">
