...
export default function SuccessStories() {
  return (
    <section className="px-8 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-7xl">
        
        {/* --- HEADER --- */}
        <div className="mb-16 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end md:gap-6">
          <div className="max-w-2xl">
            <h2 className="mb-4 text-4xl font-semibold tracking-tight text-royal-blue leading-tight md:text-5xl">
              Impact stories
            </h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
          {stories.map(({ name, role, story }, index) => (
            <div 
              key={index}
              className="group rounded-3xl border-2 border-royal-blue/10 bg-cool-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-royal-blue md:p-10"
            >
              <div className="mb-8 flex h-12 w-12 items-center justify-center rounded-2xl bg-royal-blue/5 text-royal-blue transition-colors group-hover:bg-royal-blue group-hover:text-white">
                <Quote size={22} />
              </div>
